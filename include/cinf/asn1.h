...
size_t cinf_asn1_ber_tag_length(u64 len);
int cinf_asn1_ber_tag_read(cinf_buf *buf, u64 *len);
int cinf_asn1_ber_tag_write(cinf_buf *buf, u64 len);
...
struct u64_result cinf_asn1_ber_integer_u64_read_byval(cinf_buf *buf, size_t len);
int cinf_asn1_ber_integer_u64_write_byval(cinf_buf *buf, size_t len, const u64 value);
struct u64_result cinf_asn1_der_integer_u64_read_byval(cinf_buf *buf, asn1_tag _tag);
...
struct s64_result cinf_asn1_ber_integer_s64_read_byval(cinf_buf *buf, size_t len);
int cinf_asn1_ber_integer_s64_write_byval(cinf_buf *buf, size_t len, const s64 value);
struct s64_result cinf_asn1_der_integer_s64_read_byval(cinf_buf *buf, asn1_tag _tag);
...
struct u64_result cinf_le_ber_integer_u64_read_byval(cinf_buf *buf, size_t len);
...
struct s64_result cinf_le_ber_integer_s64_read_byval(cinf_buf *buf, size_t len);
...
struct f64_result cinf_asn1_ber_real_f64_read_byval(cinf_buf *buf, size_t len);
