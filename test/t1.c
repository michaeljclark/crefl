...
void t1()
{
	...
	assert(crefl_tag(crefl_ptr(r1)) == _decl_intrinsic);
	assert(crefl_ref_tag(r1) == _decl_intrinsic);
	assert(crefl_ref_idx(r1) == 1);
	...
	assert(crefl_tag(crefl_ptr(r2)) == _decl_struct);
	assert(crefl_ref_tag(r2) == _decl_struct);
	assert(crefl_ref_idx(r2) == 2);
