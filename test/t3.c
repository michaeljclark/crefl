...
void t3()
{
    ...
    assert((crefl_decl_props(crefl_field_type(_fields[1])) & _decl_sint) == _decl_sint);
    assert((crefl_decl_props(crefl_field_type(_fields[2])) & _decl_uint) == _decl_uint);
    assert((crefl_decl_props(crefl_field_type(_fields[3])) & _decl_sint) == _decl_sint);
    assert((crefl_decl_props(crefl_field_type(_fields[4])) & _decl_uint) == _decl_uint);
    assert((crefl_decl_props(crefl_field_type(_fields[5])) & _decl_sint) == _decl_sint);
    free(_fields);
    ...
    assert((crefl_decl_props(crefl_field_type(_fields[0])) & _decl_uint) == _decl_uint);
    assert((crefl_decl_props(crefl_field_type(_fields[1])) & _decl_sint) == _decl_sint);
    assert((crefl_decl_props(crefl_field_type(_fields[2])) & _decl_uint) == _decl_uint);
    assert((crefl_decl_props(crefl_field_type(_fields[3])) & _decl_float) == _decl_float);
    assert((crefl_decl_props(crefl_field_type(_fields[4])) & _decl_float) == _decl_float);
    assert((crefl_decl_props(crefl_field_type(_fields[5])) & _decl_void) == _decl_void);
    free(_fields);
